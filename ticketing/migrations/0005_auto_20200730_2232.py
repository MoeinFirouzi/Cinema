...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ticketing', '0004_auto_20200730_2204'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='movie',
            name='director',
            field=models.CharField(max_length=50, verbose_name='تهیه کننده'),
        ),
        migrations.AlterField(
            model_name='movie',
            name='length',
            field=models.IntegerField(verbose_name='مدت'),
        ),
        migrations.AlterField(
            model_name='movie',
            name='name',
        ...
        migrations.AlterField(
            model_name='showtime',
            name='status',
            field=models.IntegerField(choices=[(1, 'فروش آغاز نشده'), (2, 'در حال فروش بلیت'), (3, 'بلیت ها تمام شد'), (4, 'فروش بلیت بسته شد'), (5, 'فیلم پخش شد'), (6, 'سانس لغو شد')], verbose_name=''),
        ),
    ]
